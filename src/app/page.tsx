      ...
      <section className="bg-gradient-to-br from-indigo-600 to-indigo-800 text-white py-24 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-indigo-200 max-w-2xl mx-auto">
            AI-powered rubric-based feedback that helps teachers evaluate
            student writing instantly. Detailed scores, strengths, improvements,
            and PDF reports.
          </p>
          ...
          <p className="text-indigo-300 text-sm">
            10 free evaluations/month · No credit card required
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={feature.title}
                className="flex flex-col items-start gap-4 p-6 rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-sm transition-all"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                step: "1",
                title: "Paste the Essay",
                desc: "Copy and paste any student essay into our evaluation tool. Select the grade level and rubric type.",
              },
              {
                step: "2",
                title: "AI Analyzes",
                desc: "Our AI evaluates the essay against your chosen rubric in seconds, scoring 4 key dimensions.",
              },
              {
                step: "3",
                title: "Download Report",
                desc: "Review detailed feedback, scores, strengths, and improvements. Export a PDF report instantly.",
              },
            ].map((item) => (
              <div
                key={item.step}
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-2xl p-6 text-left space-y-4">
              ...
              <Link
                href="/signup"
                className="block text-center py-2 px-4 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 transition-colors"
              >
                Get Started
              </Link>
            </div>
            <div className="bg-indigo-600 rounded-2xl p-6 text-left space-y-4 text-white">
              ...
              <Link
                href="/pricing"
                className="block text-center py-2 px-4 bg-white text-indigo-600 rounded-xl text-sm font-medium hover:bg-indigo-50 transition-colors"
              >
                Subscribe
              </Link>
            </div>
